...
class Game:
    def __init__(self):
        ...
        self.restart_text = self.font.render("Restart",True,(255,60,0))
    ...
    def setUpBgAndGround(self):
        ...
        self.ground2_rect.x = self.ground1_rect.right
        self.ground1_rect.y = 570
        self.ground2_rect.y = 570
